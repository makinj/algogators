var normalWebRenderer = (function(){
    ...
    function loadImages(onFinish){
        ...
        bannerImage.src = "./app/www/img/banner.svg";
        ...
        colors.forEach(function(color){
            ...
            algImage.src = "./app/www/img/alligators/gator" + color.replace("#","") + ".svg";
            ...
            eggImage.src = "./app/www/img/eggs/egg" + color.replace("#","") + ".svg";
        ...
        imgNames.forEach(function(imgName){
            var img = new Image();
            img.src = "./app/www/img/" + imgName + ".png";
